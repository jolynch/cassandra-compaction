...
public final class LimitedSizeTieredCompactionStrategyOptions
{
    ...
    protected static final String MIN_THRESHOLD = "min_threshold";
    protected static final String MAX_THRESHOLD = "max_threshold";
    ...
    private static long parseLong(Map<String, String> options, String key, long defaultValue) throws ConfigurationException
    {
        ...
        {
            throw new ConfigurationException(String.format("%s is not a parsable int (base 10) for %s", optionValue, key), e);
        }
    }
    ...
    public static Map<String, String> validateOptions(Map<String, String> options, Map<String, String> uncheckedOptions) throws ConfigurationException
    {
        ...
        long targetSSTableSize = parseLong(options, SSTABLE_SIZE_OPTION, DEFAULT_SSTABLE_SIZE_OPTION);
